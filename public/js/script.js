    ...
    $(document).ready(function () {
        ...
        if ($(".dashboard-screenshot-wrap").length) {
            $(".dashboard-screenshot-wrap").slick({
                ...
                arrows: true,
                prevArrow:
                    '<button class="dashboard-prev"><i class="fas fa-arrow-left"></i></button>',
                nextArrow:
                    '<button class="dashboard-next"><i class="fas fa-arrow-right"></i></button>',
                centerMode: true,
                centerPadding: "144px",
                slidesToShow: 1,
                slidesToScroll: 1,
